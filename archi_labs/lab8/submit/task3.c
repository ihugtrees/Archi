...
int main(int argc, char **argv){
    ...
    struct fun_desc menu[] = { { "Toggle Debug Mode",toggle_debug_mode}, { "Examine ELF File",examine_elf},{"Print Section Names",print_sections},{"Print Symbols",print_symbols},
        {"Link check",link_check},{"Relocation Tables",relocation_table},{ "Quit", quit}, {NULL,NULL} };
